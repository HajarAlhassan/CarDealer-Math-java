...
public class CarDealer {
    public static void inventory(HashMap<String,Integer> cars) {
        for(String i: cars.keySet()){
            System.out.println("Brand/Model: "+i+"\tcounts: "+cars.get(i)+"\n");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        cars.put("Honda/Oddesy",1);
        cars.put("Honda/Civic",3);
        cars.put("Hundai/Tucson",1);
        cars.put("Hundai/Kona",0);
        ...
        System.out.println("Are you employee? Yes/No");
            ...
            if(buyInput.equalsIgnoreCase("quit")||buyInput.equalsIgnoreCase("q")) break;
            if(buyInput.equalsIgnoreCase("yes")||buyInput.equalsIgnoreCase("y") ) {
                ...
                if (buyInput.equalsIgnoreCase("yes") || buyInput.equalsIgnoreCase("y")) {
                    ...
                    if(carBrand.equalsIgnoreCase("quit")||carBrand.equalsIgnoreCase("q")) break;
                ...
                if (buyInput.equalsIgnoreCase("yes") || buyInput.equalsIgnoreCase("y")) {
                    ...
                    if(carModel.equalsIgnoreCase("quit")||carModel.equalsIgnoreCase("q")) break;
